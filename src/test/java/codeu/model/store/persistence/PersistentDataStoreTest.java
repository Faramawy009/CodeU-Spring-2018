...
public class PersistentDataStoreTest {
  ...
  public void testSaveAndLoadUsers() throws PersistentDataStoreException {
    ...
    User inputUserOne = new User(idOne, nameOne,passwordOne, creationOne,"", User.LoginType.Register);

    UUID idTwo = UUID.randomUUID();
    String nameTwo = "test_username_two";
    Instant creationTwo = Instant.ofEpochMilli(2000);
    String passwordTwo = "test_password_two";
    User inputUserTwo = new User(idTwo, nameTwo,passwordTwo, creationTwo,"", User.LoginType.Register);
