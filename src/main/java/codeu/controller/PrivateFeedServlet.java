...
public class PrivateFeedServlet extends HttpServlet {
  ...
  /**
   * This function fires when a user navigates to the activity feed page. It gets all of the events
   * from the model and forwards to conversations.jsp for rendering the list.
   */
  @Override
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    request
        .getRequestDispatcher("/WEB-INF/view/privateactivityfeed.jsp")
