...
public class EventStore {
  ...
  /**
   * The PersistentStorageAgent responsible for loading in Events and saving Events to the
   * DataStore.
   */
  ...
  /**
   * Sets the List of Events stored by this EventStore. Should be called only once when data is
